"""
Django settings for cyberburguer project.
...
SECRET_KEY = 'django-insecure-9kxenon=z8nmonqrbo4&g59g6+epz%bqguo)yfkaspxe!zvt^p'
...
WSGI_APPLICATION = 'cyberburguer.wsgi.application'
